...
public class LoginService {
    ...
    public void isFirstStart() {
        if (personRepository.findAll().size() == 0) {
            ...
            p2.setDescription("doc.dentist");
            p3.setDescription("doc.cardio");
            p4.setDescription("doc.derm");
            p5.setDescription("doc.cosme");
            pa.setFirstName("Anton");
            pa.setLastName("Klimovich");
            p1.setFirstName("Boris");
            p1.setLastName("Maleev");
            p2.setFirstName("Dmitriy");
            p2.setLastName("Chubrik");
            p3.setFirstName("Vlad");
            p3.setLastName("Dekhtyarenko");
            p4.setFirstName("Egor");
            p4.setLastName("Cheptsov");
            p5.setFirstName("Anna");
            p5.setLastName("Vasilenko");
            p6.setFirstName("Nikita");
            p6.setLastName("Fridrikh");
            p7.setFirstName("Georgiy");
